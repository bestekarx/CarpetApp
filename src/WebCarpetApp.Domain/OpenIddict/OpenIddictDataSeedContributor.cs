...
namespace WebCarpetApp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("WebCarpetApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor { Name = "WebCarpetApp", DisplayName = "WebCarpetApp API", Resources = { "WebCarpetApp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["WebCarpetApp_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["WebCarpetApp_App:RootUrl"]?.TrimEnd('/');
        ...
        // Blazor Client
        var blazorClientId = configurationSection["WebCarpetApp_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["WebCarpetApp_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["WebCarpetApp_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["WebCarpetApp_Swagger:RootUrl"]?.TrimEnd('/');
