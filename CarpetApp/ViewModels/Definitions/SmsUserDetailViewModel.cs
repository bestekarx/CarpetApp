...
public partial class SmsUserDetailViewModel(IDialogService dialogService, ISmsUsersService smsUserService, IDataQueueService dataQueueService) : ViewModelBase
{
    #region Fields
